		...
		<Row gutter={16}>
			<Col xs={24} sm={24} md={24} lg={8}>
				<Flex className="h-100" flexDirection="column" justifyContent="between">
					...
					<div className="mb-4">
						<h1 className="font-weight-bold">AED27,188.00</h1>
				...
				<Flex>
					<div className="mr-3 text-right">
						...
						<div className="mb-0 h5 font-weight-bold">
							<NumberFormat prefix={'AED'} value={elm.sales} thousandSeparator={true} displayType="text" />
...
const Customers = () => {
	...
	return (
		...
		>
			<Flex>
				<div className="mr-5">
					<h2 className="font-weight-bold mb-1">1250</h2>
					<p><Badge color={COLORS[6]}/>This Month Customers</p>
				</div>
				<div>
					<h2 className="font-weight-bold mb-1">1840</h2>
					<p><Badge color={COLORS[0]}/>Last Month Customers</p>
				</div>
			</Flex>
			<div>
				<ChartWidget 
